        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show" role="alert">
                    <strong>Bilgilendirme - </strong> İçerik sayısı artıkça burada istatistik veriler gözlemlenebilir hale gelecektir.
                </div>
                        ...
                        <div class="d-flex align-items-center card-body">
                            ...
                            <div class="ms-auto">
                                <button class="btn round-50 btn-secondary text-white btn-lg icon-center">
                                    <iconify-icon icon="solar:cart-check-outline"
                                                  class="iconify-md icon-center"></iconify-icon>
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                  ...
                  <span class="flex-shrink-0">
                    <img src="../assets/images/profile/user-3.jpg" alt="user" width="56" height="56"
                         class="rounded round-50">
                                ...
                                <div class="d-flex gap-9 comment-row mb-5">
                  <span class="flex-shrink-0">
                    <img src="../assets/images/profile/user-6.jpg" alt="user" width="56" height="56"
                         class="rounded round-50">
                  </span>
                                    <div class="comment-text">
                                        <div class="hstack justify-content-between gap-6 mb-1">
                                ...
                                <div class="d-flex gap-9 comment-row mb-5">
                  <span class="flex-shrink-0">
                    <img src="../assets/images/profile/user-7.jpg" alt="user" width="56" height="56"
                         class="rounded round-50">
                  </span>
                                    <div class="comment-text">
                                        <div class="hstack justify-content-between gap-6 mb-1">
                                            ...
                                            <span
                                                class="badge bg-info-subtle text-info rounded fw-semibold p-2">Pending</span>
                                        </div>
                                        <p class="comment-details mb-6 fs-3 text-muted truncate-2">
                                            Lorem Ipsum is simply dummy text of the printing and type setting
                                            industry.
                                ...
                                <div class="d-flex gap-9 comment-row mb-5">
                  <span class="flex-shrink-0">
                    <img src="../assets/images/profile/user-5.jpg" alt="user" width="56" height="56"
                         class="rounded round-50">
                  </span>
                                    <div class="comment-text">
                                        <div class="hstack justify-content-between gap-6 mb-1">
